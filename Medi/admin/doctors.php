...
<body>
    ...
    <div class="dash-body" style="background: #58fff2">
            ...
            <tr>
                ...
                <td colspan="2">
                    <a href="?action=add&id=none&error=0" class="non-style-link"><button
                            ...
                            style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;">Add
                            New</font></button>
                    </a>
                </td>
            </tr>
                ...
                <div id="popup1" class="overlay">
                        ...
                        <br><br><br><br>
                            ...
                            <a href="doctors.php" class="non-style-link"><button  class="btn-primary btn" 
                             style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;OK&nbsp;&nbsp;</font></button></a>
